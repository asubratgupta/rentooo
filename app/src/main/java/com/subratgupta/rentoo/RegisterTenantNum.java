...
public class RegisterTenantNum extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_tenant_num);
...
//        mSignOutButton.setOnClickListener(this);
    ...
    public void goto_reg_ten(){
        Intent goToRegisterOwnerProperty = new Intent(this, RegisterTenant.class);
