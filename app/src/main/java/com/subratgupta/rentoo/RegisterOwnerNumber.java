...
public class RegisterOwnerNumber extends AppCompatActivity implements
        View.OnClickListener {

    private static final String TAG = "OwnerPhoneAuthActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_owner_number);
...
//        mSignOutButton.setOnClickListener(this);
    ...
    public void goto_reg_prop(){
        Intent goToRegisterOwnerProperty = new Intent(this, RegisterOwnerProperty.class);
        startActivity(goToRegisterOwnerProperty);
    }
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        if (user == null) {
            ...
            MainActivity.writeData("user_id",user.getUid());
