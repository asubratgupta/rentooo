...
public class ServiceProviderActivity extends AppCompatActivity implements
        View.OnClickListener{

    private static final String TAG = "ServiceAuthActivity";
...
//        mSignOutButton.setOnClickListener(this);
    ...
    public void goto_reg_service(){
        Intent goToRegisterService = new Intent(this, RegisterService.class);
        startActivity(goToRegisterService);
    }
